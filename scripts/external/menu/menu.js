    ...
    Array.prototype.forEach.call(appsMenuItems, function(el, i){
            ...
            el.addEventListener("focus", function() {
                ...
                Array.prototype.forEach.call(appsMenuItems, function(el, i){
                    ...
                    $(el).children('img').attr("src","scripts/external/menu/ico_menu-v1.png");                   
            ...
            if (this.getAttribute('aria-expanded') == 'false' || this.getAttribute('aria-expanded') == null) {
                    ...
                    $.each(pageDt, function (key, value) {
                        if (value.PageTitle != undefined) {
                            var pageHeading = value.PageTitle;
                            var _currentPageId = value.pageId;
                    ...
                    $(this).css("border", "1px solid #003058");
                    $(this).parent().find(".dummyMenuDiv").show();
                } else {
                    this.setAttribute('aria-expanded', "false");
                    $(this).parent().find('li').css({ 'background': '#FFF' })
                    $(this).css("border", "0px");
                    $(this).parent().find(".dummyMenuDiv").hide();                   
                }
        ...
        el.addEventListener("keydown", function(event) {
                switch (event.keyCode) {
                    ...
                    case keys.enter:
                         ...
                         //$("#appmenu li").attr("aria-expanded",false).css({'background':'#003058'});
                         $("#appmenu li img").attr("src","scripts/external/menu/ico_menu-v1.png");
                    case keys.space:
					   //addEventListener();
                        prevdef = true;
                        break;
